...
\begin{figure}[htbp]
  \centering % 图片居中
  \includegraphics[width=0.8\textwidth]{figure/chapter3/guolvqi.png} % 图片路径
...
\subsection[过滤工具设计计算与校核]{过滤工具设计计算与校核\protect\footnote{合同条款：5.2.1.3井筒高效清洁关键技术配套工具设计——（3）多功能过滤工具：工作允许旋转$>=120\text{rpm}$，工具内通径$>=2.688\inch$，碎屑存储量$>=30\textrm{L}$}}
