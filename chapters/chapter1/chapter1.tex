...
斜井（$\theta = 45^\circ$）中移动铁屑床的平均速度小于水平井（$\theta =90^\circ$）井斜移动铁屑床的平均速度，如图\ref{fig:iron_wire_velocity_3angles}所示。斜井中的铁屑颗粒迁移速度与环空平均流速接近，但斜井中铁屑颗粒的迁移速度仅为环空平均流速的一半左右。
...
在本节中，将改变井筒倾角，探究井筒倾角对于井筒环形空间内蜡垢颗粒运移的影响。选取了井斜$\theta_c =0$°、45°、90°，钻井液入口流速为0.59m/s，钻井液粘度为1.7mPa·s，蜡垢颗粒粒径2mm，4mm，6mm，8mm四种。图1.42(a)描述了环空流体流速0.59m/s不同粒径下0°井筒内沉积域蜡垢颗粒平均速度情况，从图中可以看出，随着蜡垢颗粒粒径增大，蜡垢颗粒的运移速度也会增大，且都高于环空流体流速。环空流体流速0.59m/s条件下，蜡垢颗粒在2.5秒后到达压力出口。与45°井筒倾角工况相比，0°倾角井筒内蜡垢颗粒具有更高的最大运移速度，但其到达最大运移速度的时间要长于45°井筒倾角工况。图1.42(b)描述了环空流体流速0.59m/s不同粒径下90°井筒内沉积域蜡垢颗粒平均速度情况，从图中可以看出，随着蜡垢颗粒粒径增大，蜡垢颗粒的运移速度出现减小情况，且都低于环空流体流速。可见由于摩擦力的作用，会导致蜡垢颗粒的运移速度下降。环空流体流速0.59m/s条件下，蜡垢颗粒在4秒后到达压力出口。与0°、45°井筒倾角工况相比，90°倾角井筒内蜡垢颗粒最大运移速度明显下降，到达压力出口的时间变长，运移效率降低。
